...
function SettingsMenu() {
  ...
  return (
    <>
        ...
        {open && (
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "center", padding: "10px 0 6px" }}>
              <div style={{ width: "32px", height: "4px", borderRadius: "2px", background: "rgba(255,255,255,0.18)" }} />
            </div>

            <div style={{ padding: "6px 16px 8px", borderBottom: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button
                ...
                style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(160,200,220,0.50)", padding: "2px", display: "flex" }}
              >
            ...
            <div style={{ padding: "6px" }}>
              ...
              >
                <RefreshCw style={{ width: "15px", height: "15px", flexShrink: 0, color: "rgba(160,200,220,0.50)" }} />
      ...
      {open && (
        <div className="fixed inset-0" style={{ zIndex: 75 }} onClick={() => setOpen(false)} />
      )}
    </>
  );
}
...
export function MobileSidebar({
  ...
  return (
    <>
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className={`fixed left-0 top-0 bottom-0 w-[280px] md:hidden flex flex-col lg-sidebar ${
                tourActive ? "z-[65]" : "z-50"
              }`}
            >
              {/* Header */}
              <div
                className="p-4 lg-divider-border-b flex-shrink-0"
              ...
              {/* Footer */}
              <div
                className="flex-shrink-0 h-12 lg-divider-border-t flex items-center justify-center gap-2"
      ...
      <style>{`
        /* ─── Variables compartidas con ChatSidebar ──────────────── */
        :root, .light {
        ...
        /* ─── Foxy mark ──────────────────────────────────────────── */
        .foxy-mark { display: flex; align-items: center; gap: 6px; }
        .foxy-dot {
        ...
        /* ─── Footer ─────────────────────────────────────────────── */
        .footer-line { height: 1px; flex: 1; background: var(--sb-footer-line); }
        .footer-text {
          font-size: 9px; font-weight: 500;
          letter-spacing: 0.13em; text-transform: uppercase;
          color: var(--sb-text-muted); opacity: 0.55; white-space: nowrap;
        }
        ...
        .lg-sidebar ::-webkit-scrollbar-thumb {
          background: var(--sb-scrollbar); border-radius: 2px;
        }
